      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2 border-l-4 border-cyan-500 pl-6">
          <h1 className="text-4xl font-bold text-white tracking-tight">
            Asztali Alkalmazások Fejlesztése 11.A
          </h1>
        ...
        <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl backdrop-blur-sm hover:border-slate-700 transition-colors">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-slate-400 text-sm">C# alapok és segédlet.</p>
            </div>
          </div>
          
          <a 
            href="https://github.com/czegledi-david/Asztali_Alkalmazasok_Fejlesztese-11-" 
            target="_blank" 
