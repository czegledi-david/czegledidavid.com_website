    ...
    <footer className="w-full border-t border-slate-800/60 bg-slate-900/20 backdrop-blur-md mt-10">
      <div className="max-w-4xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="space-y-2 text-center md:text-left">
          <p className="text-slate-300 font-semibold text-lg tracking-tight">
            Czeglédi Dávid
          </p>
          <p className="text-slate-500 text-sm">
            Készült <span className="text-cyan-400 font-medium">Next.js</span>-el.
          </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex gap-4">
            <a 
              href="https://github.com/czegledi-david" 
              target="_blank" 
              rel="noopener noreferrer"
              className="p-2 rounded-lg bg-slate-900/50 border border-slate-700 hover:border-cyan-500/50 text-slate-400 hover:text-white transition-all group"
